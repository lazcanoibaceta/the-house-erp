...
- ✅ **Etiqueta del margen por producto (corregido)**: la columna se renombró a **"Margen food"** (bruto, solo insumos, antes de packaging y comisiones). *(Se evaluó una columna "Margen delivery" = food − 25%, pero se quitó: en PedidosYa el precio de venta es distinto/más alto para absorber la comisión, así que restar 25% al precio normal daría un margen engañoso.)*
